...
uint8_t Create10BitHighAddressByte(uint16_t slave_addr, Address::Mode mode) {
  // High byte starts with 0b11110.
  return 0b11110000 | ((slave_addr >> 7) & 0b00000110) |
         (mode == Address::Mode::WRITE ? I2C_MASTER_WRITE : I2C_MASTER_READ);
}
...
uint8_t Create7BitAddressByte(uint16_t slave_addr, Address::Mode mode) {
